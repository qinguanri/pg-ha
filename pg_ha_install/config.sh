...
if [ "$exsit_1" != "1" ] || [ "$exsit_2" != "1" ] || [ "$exsit_3" != "1" ] \
    ...
    echo "$SRC_DIR/$YUM_TAR=$exsit_10", "$SRC_DIR/$YUM_PCMK_TAR=$exsit_11", "$SRC_DIR/$DATA_TAR_GZ=$exsit_12"
    exit 1
fi
